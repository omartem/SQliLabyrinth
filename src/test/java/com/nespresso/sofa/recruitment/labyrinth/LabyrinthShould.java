...
public class LabyrinthShould
{
	...
	/**
	 * each letter represent a room each | represent a gate between two room each $ represent a gate with a sensor on
	 */
	@Test
	public void be_Walkable_Till_The_End()
	{
		final Labyrinth labyrinth = new Labyrinth("A$B", "A$C", "C|E", "B$D", "B|E", "E$F", "D$F", "F|G");
		labyrinth.popIn("A");
		labyrinth.walkTo("B");
		labyrinth.walkTo("E");
		labyrinth.walkTo("F");
	...
	{
		final Labyrinth labyrinth = new Labyrinth("A$B", "A$C", "B$D");
		labyrinth.popIn("A");
		labyrinth.walkTo("B");
	...
	{
		final Labyrinth labyrinth = new Labyrinth("A$B", "A$C", "B$D", "D$E", "D$F", "F$H", "D$F");
		labyrinth.popIn("A");
		labyrinth.walkTo("B");
